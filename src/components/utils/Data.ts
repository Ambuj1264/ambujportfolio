...
export const projectCard: IProjectSectionCardData[] = [
...

  {
    ...
    techStack:
    ' React Js, Bootstrap, Redux, Node JS, Express Js, Mongo DB',
    imageUrl: 'ecomm.png',
  ...
  },
  {
    id: 4,
    title: 'Social Motion',
    techStack: 'Next.js 14, Tailwind Css, Next UI , Asternity UI, Typescript, Stripe',
    imageUrl: 'socialmotion.png',
...
export const moreProjects = [
  {
    id: 1,
    title: 'Netflix clone',
    techStack: 'React Js, Material UI, Reduxm, Axios, TMDB API, Styped components ',
    icon: 'lottery',
